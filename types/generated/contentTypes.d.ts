...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Base: Schema.Attribute.RichText &
      Schema.Attribute.Required &
    ...
    Category: Schema.Attribute.Integer &
      Schema.Attribute.CustomField<'plugin::category-manager.category-selector'>;
    ...
    LanguageProcessor: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<'plugin::per-language.language-processor'>;
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::collection.collection'
    >;
    PerLanguage: Schema.Attribute.Text &
      Schema.Attribute.CustomField<'plugin::per-language.collection-perlanguage'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface PluginCategoryManagerCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    taxon: Schema.Attribute.Relation<
      'manyToOne',
...
export interface PluginCategoryManagerTaxon
  extends Struct.CollectionTypeSchema {
...
export interface PluginChineseArticleProcessorArticleSentence
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    per_language_id: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sentence_order: Schema.Attribute.Integer & Schema.Attribute.Required;
    sentence_text: Schema.Attribute.RichText & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginChineseArticleProcessorSentenceGrammarRule
  ...
  attributes: {
    ...
    sentence_id: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginChineseArticleProcessorSentenceTranslation
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sentence_id: Schema.Attribute.Integer & Schema.Attribute.Required;
    translation_language: Schema.Attribute.String & Schema.Attribute.Required;
    translation_text: Schema.Attribute.RichText & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginPerLanguageArticlePerlanguage
  ...
  attributes: {
    access_tier: Schema.Attribute.String;
    article_id: Schema.Attribute.Integer & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    difficulty_data: Schema.Attribute.JSON;
    display_skill: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    per_language_text: Schema.Attribute.Text & Schema.Attribute.Required;
    processed_data: Schema.Attribute.JSON;
...
export interface PluginPerLanguageCollectionPerlanguage
  ...
  attributes: {
    access_tier: Schema.Attribute.String;
    collection_id: Schema.Attribute.Integer & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
