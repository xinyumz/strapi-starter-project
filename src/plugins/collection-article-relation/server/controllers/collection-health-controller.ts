// src/plugins/collection-article-relation/server/controllers/collection-health-controller.ts
...
export default ({ strapi }: any) => ({
     ...
     * GET /collection-article-relation/health/overview
    ...
    async getCombinedHealthOverview(ctx: any) {
        ...
        try {
            ...
            const collectionHealthService = strapi.plugin('collection-article-relation').service('collectionHealth');
     ...
     * GET /collection-article-relation/health/overview/force
     */
     ...
     * GET /collection-article-relation/health/metrics
     */
     ...
     * DELETE /collection-article-relation/health/cache
     */
    async clearHealthCache(ctx: any) {
        try {
            ...
            const duplicateDetectionService = strapi.plugin('collection-article-relation').service('duplicateDetection');
