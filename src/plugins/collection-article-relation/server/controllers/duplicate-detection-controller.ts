// src/plugins/collection-article-relation/server/controllers/duplicate-detection-controller.ts
...
export default ({ strapi }: any) => ({
     ...
     * GET /collection-article-relation/duplicates/detect
     ...
     * GET /collection-article-relation/duplicates/stats
     * Supports ?bypass=true query parameter for cache bypass
     */
     ...
     * GET /collection-article-relation/duplicates/groups/:fingerprint
     */
     ...
     * GET /collection-article-relation/duplicates/detect/force
     */
     ...
     * GET /collection-article-relation/duplicates/stats/force
     */
