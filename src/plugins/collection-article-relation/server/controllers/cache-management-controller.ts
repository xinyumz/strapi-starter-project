// src/plugins/collection-article-relation/server/controllers/cache-management-controller.ts
...
export default ({ strapi }: any) => ({
     ...
     * DELETE /collection-article-relation/orphans/cache
     */
     ...
     * DELETE /collection-article-relation/orphans/cache/:id
     */
     ...
     * GET /collection-article-relation/orphans/cache-stats
     */
