...
import { useHSKManagement, useGrammarManagement, useSelectionManagement } from './hooks';
...
const ChineseArticleProcessor = () => {
  ...
  // Initialize selection management hook
  const {
    selectedRules,
    toggleRuleSelection,
    isRuleSelected,
        ...
        {isLoading && !isTranslating && !isCalculatingHSK && !isProcessing ? (
          ...
          <>
            ...
            <GrammarSection
              ...
              onDeleteSelected={handleShowBulkDeleteConfirm}
