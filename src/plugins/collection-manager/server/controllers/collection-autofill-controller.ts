// src/plugins/collection-manager/server/controllers/collection-autofill-controller.ts
...
export default ({ strapi }: any) => ({
    ...
    async health(ctx: any) {
        try {
            ...
            ctx.body = {
                ...
                endpoints: {
                    quickCreate: '/collection-manager/quick-create',
                    health: '/collection-manager/health',
                    cacheStats: '/collection-manager/cache/stats'
                },
                capabilities: [
     ...
     * POST /collection-manager/cache/clear
     */
