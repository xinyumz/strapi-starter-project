// src/plugins/collection-manager/server/routes/collection-autofill-routes.ts
...
export default [
    ...
    // Health check endpoint (detailed)
    {
        ...
        config: {
            ...
            description: 'Detailed health check endpoint for the collection-manager plugin',
